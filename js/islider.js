...
iSlider = function () {
  ...
  iSlider.prototype._renderItem = function (el, i) {
    ...
    var insertImg = function () {
      html = item.height / item.width > self.ratio ? '<img onerror="nofind(this,1)" height="' + self.height + '" src="' + item.content + '">' : '<img onerror="nofind(this,1)" width="' + self.width + '" src="' + item.content + '">';
      el.innerHTML = html;
    };
